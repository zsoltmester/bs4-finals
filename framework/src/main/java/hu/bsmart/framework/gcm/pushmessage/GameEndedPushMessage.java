 ...
 */
public class GameEndedPushMessage extends PushMessage {
	...
	public PushMessageType getPushType() {
		return PushMessageType.GAME_ENDED;
	}
	...
	String getEventSummary(Context context) {
		return context.getString(R.string.game_ended_push_message_summary);
	}
	...
	String getEventDetails(Context context) {
		return context.getString(R.string.game_ended_push_message_details, teamName, gameName);
	}
